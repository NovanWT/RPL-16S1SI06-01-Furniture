      ...
      <div class="sidebar">
        <nav class="sidebar-nav">
          <ul class="nav">
            ...
            <li class="nav-title">Selamat Datang</li>
            <li class="nav-item">
              <a class="nav-link" href="#">
                <i class="nav-icon icon-drop"></i> Keluar</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="#">
                <i class="nav-icon icon-pencil"></i> Masuk</a>
            </li>
            <li class="nav-title">Components</li>
            <li class="nav-item">
              <a class="nav-link" href="index.php?halaman=produk">
                <i class="nav-icon icon-puzzle"></i> Produk</a>
            ...
            <li class="nav-item">
              <a class="nav-link" href="index.php?halaman=kategori">
                <i class="nav-icon icon-cursor"></i> Kategori</a>
                <!--
              <ul class="nav-dropdown-items">
                <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="nav-link" href="index.php?halaman=pelanggan">
                <i class="nav-icon icon-star"></i> Pelanggan</a>
            </li>

            <li class="nav-item">
              <a class="nav-link" href="index.php?halaman=notapembelian">
                <i class="nav-icon icon-star"></i> Nota Pembelian</a>
                <!--
              <ul class="nav-dropdown-items">
                <li class="nav-item">
            ...
            <li class="nav-item nav-dropdown">
              <a class="nav-link nav-dropdown-toggle" href="#">
                <i class="nav-icon icon-bell"></i> Tutorial</a>
              <ul class="nav-dropdown-items">
              <!--
                <li class="nav-item">
          ...
          <li class="breadcrumb-menu d-md-down-none">
            ...
            <br>
              ...
              if (isset($_GET['halaman']))
              {
                ...
                elseif ($_GET['halaman']=='notapembelian')
                {
