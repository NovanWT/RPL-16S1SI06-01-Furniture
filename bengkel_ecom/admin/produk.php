	            ...
	            <div class="panel-body">
	                <div class="table-responsive">
						<table class="table table-bordered table-hover table-striped" id="dataTables">
							...
							<?php
							$no = 1;
							$sql_user = mysqli_query($con, "SELECT * FROM tbl_produk") or die($con->error);
							while ($data = mysqli_fetch_array($sql_user)) {?>
								<tr>
									<td align="center"><?=$no++;?>.</td>
									
									
									<td><?=$data['id_kategori_produk'];?></td>
									<td><?=$data['id_merek'];?></td>
									...
									<td><?=$data['gambar'];?></td>
									<td align="center">
										<a href="<?=$base_url;?>/admin/?p=user&act=edit&id=<?=$data['id_user'];?>" class="btn btn-xs btn-info">Edit Email / Password</a>
									</td>
								</tr>
							<?php }?>
							</tbody>
	                ...
	                <div class="row">
						<div class="col-lg-12">
			                ...
			                <div class="pull-right">
								<a href="<?=$base_url;?>/admin/?p=user" class="btn btn-xs btn-warning">Kembali</a>
			                </div>
						</div>
	                </div>
	            </div>
	            	...
	            	<div class="row">
	            		<div class="col-lg-6">
							...
							if (@isset($_POST['edit'])) {
						        ...
						        header("location: " . $base_url . "/admin/?p=user");
						    } ?>
						</div>
					</div>
	            </div>
